    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">AndevWebDevelopment</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/b1.jpg" class="user-image img-responsive"/>
					</li>
				
					
                    <li><a href="index.php"><i class="fa fa-dashboard "></i>Home</a></li>
                     <li><a href="kategori.php"><i class="fa fa-dashboard "></i>Kategori</a></li>
                    <li><a href="index.php?halaman=produk"><i class="fa fa-picture-o"></i>Produk</a></li>
